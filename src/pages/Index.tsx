    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="relative overflow-hidden bg-[image:var(--gradient-hero)] text-white py-16 px-4">
        ...
        <div className="max-w-4xl mx-auto text-center relative">
          ...
          <Alert className="mt-4 bg-white/10 border-white/20 text-white max-w-2xl mx-auto backdrop-blur-sm">
            <AlertCircle className="h-4 w-4" />
            <AlertDescription>
              This is a long-range outlook based on historical climate patterns.
